...
## Consequences
- ✅ **Honours ADR-001 instead of contradicting it** — the revisit trigger is named, shown firing, and acted on. The obvious question *"why didn't you use LangGraph?"* becomes *"I used it exactly where it earns its place — here's the loop, here's the graph, and here's the line between them."*
...
- ⚠️ **Demo-stage risk** — built late, on a branch, additive. If it isn't demo-stable it simply isn't merged; `main` (the production build) stays green.
