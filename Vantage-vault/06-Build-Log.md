...
- [~] **Slice 4** — reusable **Skill runner** + seeded **Customer Escalation Summary** ✅ (PR #9); user **Skill authoring** (Flow 1: turn a session into a skill) — *next* (differentiator beyond the Must).
